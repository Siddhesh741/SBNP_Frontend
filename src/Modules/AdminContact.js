    ...
    const initialFormData = {
      ...
      const handleNumberChange = (e) => {
        ...
        if (/^\d{0,10}$/.test(value)) {
          ...
          setErrors({
            ...errors,
            phoneNumber: "Phone number should only contain digits and be up to 10 characters.",
          });
        }
      };
      ...
      const handleNumberChange2 = (e) => {
        ...
        if (/^\d{0,10}$/.test(value)) {
          ...
          setErrors({
            ...errors,
            photographerPhoneNo: "Phone number should only contain digits and be up to 10 characters.",
          });
        }
      };
      //Date
                ...
                {showCashCollectedByField && (
                  <div className="form-group mb-4">
                    ...
                    <select
                      ...
                      style={{ height: "30px", width: "calc(95% - 5px)" }}
                    >
